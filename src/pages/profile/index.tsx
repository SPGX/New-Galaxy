...
export default function Profile({}: IProps): ReactElement {
  ...
  const handleUpdate = () => {
    setTitle('The phone number update is complete.')
    setshowAlert(true)
    setTimeout(() => {
      setshowAlert(false)
      setOTP(true)
            ...
            <div className='flex items-center w-full flex-col'>
              <div className='flex items-center w-[80%] md:w-[560px] justify-center mb-5'>
                <div className='w-full flex items-center justify-between'>
                  <div className='text-bluePrimary text-sm text-white justify-items-start w-[75%]'>Name</div>
                  <div className={'mx-10 my-1 text-sm text-gray-400 w-full'}>Tom Cruise</div>
                </div>
              </div>

              <div className='flex items-center w-[80%] md:w-[560px] justify-center mb-5'>
                <div className='w-full flex items-center justify-between'>
                  <div className='text-bluePrimary text-sm text-white justify-items-start w-[75%]'>Date of Birth</div>
              ...
              <div className='flex items-center w-[80%] md:w-[560px] justify-center mb-5'>
                <div className='w-full flex items-center justify-between'>
                  <div className='text-bluePrimary text-sm text-white justify-items-start w-[75%]'>Gender</div>
                  <div className={'mx-10 my-1 text-sm text-gray-400 w-full'}>Male</div>
                </div>
              </div>
                ...
                <div className='flex items-center w-full flex-col'>
                  ...
                  <div className='w-full justify-center flex'>
                    <div className='justify-between flex flex-rows w-1/3 items-center flex-wrap'>
                      <input
                        type='search'
                        placeholder='Please enter 6 digits OTP here'
                        value={NumOTP}
                        onChange={(e) => setNumOTP(e.target.value)}
                        className={
                          'mx-3 my-1 bg-transparent h-9 w-[200px] text-[4px] text-gray-400 rounded-2xl pl-5 pr-3 outline-none focus:border-none focus:outline-none focus:bg-gray focus:text-white '
                        }
                      />
                      <Button
                        handlerClicked={() => {}}
